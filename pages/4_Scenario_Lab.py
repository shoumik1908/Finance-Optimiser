"""
Scenario Lab — JSON test harness (White + Purple theme)
"""
import streamlit as st
import json
from engine import optimise_finances, project_finances, generate_summary, DEFAULT_PROFILE
from ui import inject_css, plan_report, PURPLE, PURPLE_BG, TEXT, TEXT_SEC
...
<div style="display:flex; justify-content:space-between; align-items:center; padding:12px 0; border-bottom:1px solid #E5E7EB; margin-bottom:24px;">
    ...
    <div style="display:flex; gap:8px;">
        ...
        <a href="/Scenario_Lab" target="_self" style="font-family:Inter,sans-serif; font-size:0.85rem; color:{PURPLE}; text-decoration:none; padding:6px 14px; border-radius:8px; background:{PURPLE_BG};">Scenario Lab</a>
...
st.markdown(f'<p style="color:{TEXT_SEC}; font-size:0.9rem; margin-bottom:24px;">Paste a JSON financial profile and test the optimiser. The unseen scenario test harness.</p>', unsafe_allow_html=True)
